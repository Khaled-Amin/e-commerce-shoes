                ...
                <div class="card">
                    <div class="card-header bg-primary">
                        ...
                        align-items: center;">
                            ...
                            <a href="{{url('admin/orders')}}" class="btn btn-warning text-white float-start">Back</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mt-3">
                                    <label class="mb-2 mt-2 text-muted" for="">Order Status </label>
                                    <form action="{{route('update.orders' , $orders->id)}}" method="POST">
                                        ...
                                        <button type="submit" class="mt-2 mb-2 btn float-start btn-primary">Update</button>
                                    </form>
                                </div>
                                <a href="{{route('generate.pdf', $orders->id)}}" class="btn btn-danger mt-2 mx-2">
                                    Print<i class="fa fa-print mx-2" title="print"></i>
                                </a>
                            </div>
                        </div>
