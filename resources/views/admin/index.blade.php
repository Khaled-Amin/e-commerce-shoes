        ...
        <ul class="header_menu">
            ...
            <li><a data-toggle="dropdown" href="#"><i class="far fa-user"></i></a>
                <div class="user_item dropdown-menu dropdown-menu-right">
                    <div class="admin">
                        <a href="#" class="user_link"><img src="{{url('../uploads/login-img.png')}}" alt=""></a>
                    </div>
                    <ul>
        ...
        @if (Session::has('error'))
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                ...
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"
                    style="width:10px !important; height:10px !important; color:#000;line-height:10px;"><i
                        class="fa-sharp fa-solid fa-xmark"></i></button>
            </div>
        @endif
        <h3>Login Admin Name: {{ Auth::guard('admin')->user()->name }}</h3>
        <h3>Login Admin E-mail: {{ Auth::guard('admin')->user()->email }}</h3>
